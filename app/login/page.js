        ...
        <div className='text-white py-14 container mx-auto '>
            ...
            <div className="social-login-buttons">
                <div className="flex flex-col gap-2 min-h-screen items-center  p-10">
                    ...
                    <button
                        className="flex items-center w-64  bg-slate-700 text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center w-64  bg-slate-700 text-white border border-gray-300 hover:text-black rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
